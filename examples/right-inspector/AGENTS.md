...
registry. It registers one passive right-lane inspector through public wire
nodes and the published user kit. Core owns right-to-bottom degradation,
layout, rendering, and width truth.
