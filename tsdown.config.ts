...
export default defineConfig({
  ...
  entry: ['lib/types/{index,invariant,startup,theme-dark,theme-light,theme-auto,theme-custom,editor-plus,status-basic,status-git,status-context,pane-activity,pane-todo,pane-btw,pane-queue,attachments,paste-image,intent-diff,intent-terminal,banner}.js'],
  outDir: 'lib',
  format: ['esm'],
  platform: 'node',
  target: 'es2024',
