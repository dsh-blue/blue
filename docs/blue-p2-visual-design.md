...
| 12 | 思维链与活动指示 | reasoning 永远全量内联可见；activity pane 单态恒显、与 thinking 双转 | live spinner + 尾部 2 行滚动，完成自动折叠 2 行 + ctrl+o；活动模式机（waiting/tool=moon、thinking 空、composing 空窗——dogfood 复议） | S17 |
