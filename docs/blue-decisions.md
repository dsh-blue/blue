...
### D48. paste-image 失败分级提示 + 多类型探测：提示缺失而非代装（用户裁决，2026-08-22；编号避开在途 PR #19 的 D45-D47）
