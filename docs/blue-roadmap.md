...
P2 表现力      → 视觉对齐（S10-S21）/ intent / 滑动窗口 / 图片 （体验对齐，S10-S16 已落地，S17-S21 排期中——会话流对齐 2026-08-20 立项；窗口与图片已随 S7）
