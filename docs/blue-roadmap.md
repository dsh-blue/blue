...
P2 表现力      → 视觉对齐（S10-S21）/ intent / 滑动窗口 / 图片 （体验对齐，S10-S18 已落地、S19/S21 随 S17 dogfood 拉前；S20 前半已落地（三态卡片头/动词标签/3 行预览/ctrl+o 3-turn 范围），剩 S20 后半（Read 分组 + shell 呈现）；窗口与图片已随 S7）
