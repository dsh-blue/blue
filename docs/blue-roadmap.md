...
P2 表现力      → 视觉对齐（S10-S21）/ intent / 滑动窗口 / 图片 （体验对齐，S10-S17 已落地——S18 助手半边、S19、S21 随 S17 dogfood 拉前；剩 S18 用户回显 + S20 工具卡；窗口与图片已随 S7）
