...
As of 2026-08-22, `pnpm run test` (1808 tests, 103 files), `pnpm run test:coverage` (per-file 100%), `pnpm run typecheck`, `pnpm run lint`, and `pnpm run smoke:happy` (real-process width smoke) all pass on Node 22+/pnpm 11.
