...
| bundle/blue | `@dsh-blue/blue` | installable unit | `cordis.patch.yml` (three segments, Blue-owned four-preset roster + thin-host disables + isolated S39 cordis host runner) · `presets/` · `bundle.spec.ts` drift guard | [AGENTS.md](packages/bundle/blue/AGENTS.md) |
