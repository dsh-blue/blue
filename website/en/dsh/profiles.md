...
- local checkouts install via the `link:` protocol during development (Blue's [contributor guide](/en/plugins/contributing) links its thirteen packages exactly this way);
