...
Blue is a Cordis plugin tree. The bundle currently has 34 Blue-owned rows: three host-support rows, one private-runtime composition group, nine baseline rows, 15 enhancement rows, and six assembly rows.
