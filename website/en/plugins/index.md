...
- [Public UI kit](/en/plugins/ui-kit), [UI node reference](/en/plugins/ui-reference), and [example catalog](/en/plugins/examples) — pure builders, field-level contracts, shared components, and seven packed examples.
...
- [Debugging & validation](/en/plugins/testing) — profile install, the iteration loop, published validate/conformance commands, and unload-semantics checks;
