...
Blue bundle 在 `dsh-base` 上插入 31 个普通 Cordis sibling：6 个 dsh 支撑行
与 25 个 Blue product 行。不存在 group/isolate 或私有 service realm。
...
- activity/queue/todo/BTW/agents pane；
- attachments、paste image、editor-plus、interaction。
