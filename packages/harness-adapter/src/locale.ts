 ...
 * client's browser/React runtime outside the terminal frontend tree.
 *
 * Deletion condition: remove this adapter when Harness publishes a
 * renderer-neutral locale service with the same system fallback, settings
...
/** Locale service is available even when the optional settings service is absent. */
