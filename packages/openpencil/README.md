...
Optional renderer-neutral adapter for `@zseven-w/dsh-openpencil`. It observes official `tools/result` outcomes and publishes bounded Blue tool presentation models with text or diff fallback.
