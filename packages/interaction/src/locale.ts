...
const zh: Readonly<Record<string, string>> = {
  ...
  'Esc / Enter / q to cancel': 'Esc / Enter / q 关闭',
  'Select': '选择',
  ...
  'Esc close': 'Esc 关闭',
  'Enter choose · Esc close': 'Enter 确认 · Esc 关闭',
  'Enter install · Esc close': 'Enter 安装 · Esc 关闭',
  'Tab pages · ↑↓ rows · ←→ action · Enter run · Alt+S remove · Esc close': 'Tab 切页 · ↑↓ 选择 · ←→ 动作 · Enter 执行 · Alt+S 移除 · Esc 关闭',
  'Approve {tool}?': '是否批准 {tool}？',
  'Type feedback · Enter submit · Esc reject': '输入反馈 · Enter 提交 · Esc 拒绝',
  '↑↓ select · 1-4 choose · Enter confirm · Esc reject': '↑↓ 选择 · 1-4 选择 · Enter 确认 · Esc 拒绝',
  'Question {current} of {total}': '问题 {current}/{total}',
  'Other': '其他',
  'Other: {value}': '其他：{value}',
  'Answer': '回答',
  'Enter save · Tab next · Esc cancel': 'Enter 保存 · Tab 下一项 · Esc 取消',
