...
- `blueLocale` (`BlueLocaleService`) is a frontend-tree locale registry for English and Simplified Chinese. Package-owned catalogs, preference snapshots, interpolation, and subscriptions stay renderer-neutral and Fiber-disposable; missing runtime/catalog entries fall back to English source keys.
