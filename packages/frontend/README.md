...
- `blueLocale` (`BlueLocaleService`) is a frontend-tree-scoped locale registry for English and Simplified Chinese. Package-owned dictionaries, interpolation, live revision subscriptions, and English/key fallback stay renderer-neutral; settings and operating-system detection live in the Harness adapter.
