...
export interface ListView { readonly kind: 'list'; readonly items: readonly { readonly id: string; readonly label: string; readonly detail?: string; readonly disabled?: boolean }[]; readonly selectedId?: string }
...
export interface StatusModel { readonly kind: 'status'; readonly id: string; readonly view: View; readonly priority?: number; readonly band?: 'left' | 'center' | 'right'; readonly visible: boolean }
...
export interface EditorModel { readonly kind: 'editor'; readonly id: string; readonly value: string; readonly placeholder?: string; readonly enabled: boolean; readonly submit?: Action }
