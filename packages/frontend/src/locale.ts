 ...
 */
export function interpolateLocaleMessage(message: string, values?: BlueLocaleValues): string {
  return values === undefined ? message : interpolate(message, values)
}

function interpolate(message: string, values: BlueLocaleValues): string {
