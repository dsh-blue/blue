import type { BlueSessionSnapshot, BlueResult } from '@dsh-blue/blue-api'
...
/** Remote transport mutation vocabulary; it is not a Blue plugin capability. */
export type RemoteSessionAction = { readonly kind: 'followup' | 'steer', readonly text: string } | { readonly kind: 'interrupt' }
...
export interface RemoteTransport {
  ...
  request(sessionId: string, action: RemoteSessionAction, signal: AbortSignal): Promise<void>
