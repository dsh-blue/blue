...
The old `blue-status-context` remains the renderer baseline until this slice receives manual TUI acceptance. Remove this bridge when the upstream context projection/action contract is available directly to all supported Harness lines.
